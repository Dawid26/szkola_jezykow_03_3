...
if (isset($_POST['addRecord'])) {
    ...
    $query = "INSERT INTO fiszki ( nazwa, opis, zdjecie, wymowa,kurs_kurs_id)
                       VALUES ( :nazwa, :opis, :zdjecie,:wymowa, :kurs_kurs_id)";
    ...
    if ($result) {
        ...
        <script>
            window.setTimeout(function () {
                window.location = 'dodaj-fiszki.php';
            }, 1000);
        </script>
        <p></p>
        <?php
...
<div class="container">
    <form method="post" action="">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="wymowa" name="wymowa" value="">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="kurs_kurs_id" name="kurs_kurs_id" value="" required>
            </div>
        </div>
