...
echo ' ' . (isset($_SESSION["cena_calkowita"]) ? "<p><b>Kwota do zapłaty za ostatnie zakupy to :</b> " . $_SESSION["cena_calkowita"] .' zł</p>' : '<b>Kwota do zapłaty za ostatnie zakupy to :</b> ' . 'Brak danych');
