...
if (!isset($_POST['updateRecord'])) {
    ...
    if (!isset($_POST['id'])) {
        ...
        $query = "UPDATE   nauczyciel 

    SET nauczyciel.imie=:imie,
    nauczyciel.nazwisko= :nazwisko,
     nauczyciel.email= :email,
    nauczyciel.miniaturka_zdjecia = :miniaturka_zdjecia,
    nauczyciel.uprawnienia = :uprawnienia,
    nauczyciel.data_dolaczenia = :data_dolaczenia
   WHERE nauczyciel.nauczyciel_id = :id";
